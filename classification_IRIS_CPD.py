...
layer = CPD(N, r, p, output_shape=C).cuda()
...
#%%
# Train the model
layer.tensor_network.accumulating_swipe(xinp_train, y_train, bf, lr=1.0, convergence_criterion=convergence_criterion, orthonormalize=False, method='ridge_exact', eps=0.5, verbose=True, num_swipes=10)
#%%
