...
if __name__ == "__main__":
    ...
    layer.tensor_network.scipy_swipe(xinp_train, y_train, bf, minres, batch_size=batch_size, num_swipes=num_swipes, lr=1.0, max_iter=max_iter, tol=tol, verbose=2, loss_callback=loss_callback, block_callback=convergence_criterion)