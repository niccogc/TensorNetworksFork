...
X = pd.read_csv('../raw/WEC/WEC_Sydney_100.csv')
# y = X.pop()
individual_power = [f'Power{i}' for i in range(1,101)]
...
torch.save(out, '../data/wecsid100.pt')
print('Saved higgs dataset to ../data/wecsid100.pt')
