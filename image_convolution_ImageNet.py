...
data_path = "/work3/s183995/ImageNet/data"

train_dataset = torchvision.datasets.ImageNet(root=data_path, train=True,
...
#%%
test_dataset = torchvision.datasets.ImageNet(root=data_path, train=False,
