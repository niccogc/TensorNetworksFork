...
#%%
layer.tensor_network.gradient_swipe(xinp_train, y_train, bf, batch_size=1024, num_swipes=num_swipes, lr=1.0, max_iter=100, verbose=2, block_callback=convergence_criterion)
#%%